...
async def create_polls(message: types.Message):
    ...
    try:
        ...
        return await message.answer(f"Не удалось создать опрос, попробуйте еще раз")
